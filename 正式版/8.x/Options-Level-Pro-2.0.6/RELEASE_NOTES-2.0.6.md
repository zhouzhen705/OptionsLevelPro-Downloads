# Release Notes / Options Level Pro 2.0.6 / ATAS 8.x

This is a stable Options Level Pro 2.0.6 release package for ATAS 8.x.
这是适用于 ATAS 8.x 的 Options Level Pro 2.0.6 稳定发布包。
