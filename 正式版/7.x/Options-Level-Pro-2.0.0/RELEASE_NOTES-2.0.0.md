# Release Notes / Options Level Pro 2.0.0 / ATAS 7.x

This is a stable Options Level Pro 2.0.0 release package for ATAS 7.x.
这是适用于 ATAS 7.x 的 Options Level Pro 2.0.0 稳定发布包。
