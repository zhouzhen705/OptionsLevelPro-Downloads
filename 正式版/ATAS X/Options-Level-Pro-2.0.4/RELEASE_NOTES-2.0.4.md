# Release Notes / Options Level Pro 2.0.4 / ATAS X

This is a stable Options Level Pro 2.0.4 release package for ATAS X.
这是适用于 ATAS X 的 Options Level Pro 2.0.4 稳定发布包。
...
- Unified the ATAS X release-package version number at ``2.0.4``.
- ATAS X 发布包版本号统一为 ``2.0.4``。
